...
public class BusinessResource implements BusinessApi {
    ...
    @Override
    public ResponseEntity<Business> getBusinessMetadatas(Integer id) {
    ...
    @Override
    public ResponseEntity<Business> updateBusinessMetadatas(Integer id, Business business) {
    ...
    @Override
    public ResponseEntity<Void> deleteBusiness(Integer id) {
        BusinessEntity business = businessRepository.findById((long) id).orElseThrow(() -> new NotFoundException());
